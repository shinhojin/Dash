...
function printHelp () {
  ...
  echo "  supply.sh -m up|down|generate [-c <channel name>] [-t <timeout>] [-d <delay>] [-f <docker-compose-file>] [-s <dbtype>] [-i <imagetag>]"
  echo "  supply.sh -h|--help (print this message)"
  ...
  echo "	supply.sh -m generate"
  echo "	supply.sh -m up"
  echo "	supply.sh -m down"
}
